...
declare function Toast({ description, duration, title, open, onOpenChange, }: ToastProps): react_jsx_runtime.JSX.Element;
...
declare function Tooltip({ content, triggerAsChild, sideOffset, dataSide, ...props }: TooltipProps): react_jsx_runtime.JSX.Element;
